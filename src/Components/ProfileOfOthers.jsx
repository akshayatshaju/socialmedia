...
const ProfileOfOthers = () => {
      ...
      const updatedPosts = searcheduser.posts.map((post) => {
        if (post.id === id) {
          return {
            ...post,
            is_liked_or_not:
              likeresponse.data.message === "You have liked this post",
  ...
  const handleSavedPost = async (id) => {
    try {
      const savedresponse = await axiosInstance.post(
        `${baseUrl}posts/savepost`,
        { id: id }
      );
    ...
    <>
        ...
        <>
          <div className="home h-screen">
            <Navbar
              ...
              pic={userName ? userName.profile_pic : null}
            />
            <div className="flex flex-row h-screen">
              ...
              <div className="w-full flex justify-center">
                {searcheduser ? (
                  ...
                  >
                    <div className="bg-grey-300 rounded-lg py-8  shadow-md text-center overflow-y-scroll ">
                      <div className="mb-6">
                        ...
                        <h1 className="text-xl font-bold mb-2">
                          {searcheduser.user_data.username}
                        </h1>
                        ...
                        <div className="text-gray-600 mb-2 follow-stats">
                          <div>
                            ...
                            <p className="text-xl">
                              {searcheduser.user_data.followers_count}
                            </p>
                          </div>
                          <div>
                            <p className="font-bold">Following</p>
                            <p className="text-xl">
                              {searcheduser.user_data.followings_count}
                            </p>
                          </div>
                          <div>
                        ...
                        <div className="text-grey-600 mb-2">
                          ...
                          {searcheduser.user_data.phone && (
                            <p>Phone Number: {searcheduser.user_data.phone}</p>
                          )}
                          {searcheduser.user_data.name && (
                            <p>Name: {searcheduser.user_data.name}</p>
                          )}
                        </div>
                        ...
                        <button
                          ...
                          onMouseOver={(e) => {
                            e.currentTarget.style.backgroundColor = "#D15A5A";
                            e.currentTarget.style.color = "black";
                          }}
                          onMouseOut={(e) => {
                            e.currentTarget.style.backgroundColor = "white";
                            e.currentTarget.style.color = "#D15A5A";
                          }}
                        >
                                ...
                                >
                                  {p.post_media[0] && (
                                    <Card.Img
                                      ...
                                      onClick={() =>
                                        openMediaSliderModal(p.post_media)
                                      }
                                    />
                                  )}
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <div
                                        className="save-btn ml-4"
                                        onClick={() => handleSavedPost(p.id)}
                                      >
                                        {console.log(
                                          p.saved_or_not,
                                          "saved or not"
      ...
      {open && mediafiles && (
        <div className="fixed top-0 left-0  bg-transparent z-50 flex items-center justify-center">
          ...
          <Carousel
            style={{ maxWidth: "50%", marginLeft: "20%", marginTop: "2%" }}
          >
