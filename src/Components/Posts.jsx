...
function Posts({ username, posts, pic, isMypost }) {
  ...
  return (
    <div className="rounded-lg w-full border max-w-4xl mx-auto my-8 bg-white">
      ...
      <div className="container h-[35rem] overflow-y-scroll no-scrollbar bg-slate-300">
        {/* post listing */}
        <div className="postlisting">
          {userposts.map((post, index) => (
            <div
              key={index}
              className="post-card border-b border-solid border-black"
            >
                    ...
                    <div key={index}>
                      ...
                      {media.media_file && (
                        <img
                          ...
                          alt="Post"
                          className="post-image mb-3 rounded-md"
                        />
                      )}{" "}
                    </div>
                  ))}
              ...
              <div className="post-details pb-3">
                ...
                <div className="post-actions flex items-center">
                  ...
                  >
                    {console.log(post.saved_or_not, "saved or not")}
                    <FontAwesomeIcon
                      icon={faBookmark}
